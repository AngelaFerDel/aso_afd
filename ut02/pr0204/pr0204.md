...
Para matar un proceso usaremos el comando `kill -9`, deberemos mirar primero el ID del proceso para poder añadirlo al final del comando de la siguiente manera:
...
El comadno `kill` sin ningún tipo de modificador envía una petición **SIGTERM 15**, este tipo de solicitud pide que cuando sea seguro se detenga el proceso.
