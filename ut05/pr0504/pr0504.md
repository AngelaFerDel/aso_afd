...
Como hemos hecho hasta ahora, creamoa la GPO y la vinculamos a nuestro dominio raiz.

![Captura apartado 1](pr0504_Capturas/pr0504_16.png)
...
![Captura apartado 1](pr0504_Capturas/pr0504_17.png)

- Crea y vincula un Filtro WMI que haga que esta GPO solo se aplique a equipos que tengan más de 4 GB de memoria RAM.

Primero crearemos el filtro WMI, desde Administración de directivas de grupo, en Filtros WMI le damos clic derecho > Nuevo...

![Captura apartado 1](pr0504_Capturas/pr0504_18.png)

En el filtro WMI le pondremos nombre y una descripción clara, además le daremos al botón de **Agregar**, esto nos permite añadir que factor queremos hacer filtro en el equipo, escribiremos:

`SELECT * FROM Win32_ComputerSystem WHERE TotalPhysicalMemory >= 4294967296`

![Captura apartado 1](pr0504_Capturas/pr0504_19.png)

Una vez hemos hecho esto le damos a **Guardar** y **Aplicar**

Volvemos a nuestro GPO_HighPref_Security, le haremos un único clic y en la parte de la derecha donde aparece información relevante abajo del todo tenemos un apartado de **Filtro WMI**, mediante el despleganle seleccionamos el filtro que acabamos de crear.

![Captura apartado 1](pr0504_Capturas/pr0504_20.png)
...
Creamos y vinculamos una GPO a nuestro dominio raíz.

![Captura apartado 1](pr0504_Capturas/pr0504_21.png)

- Configurar la directiva de UAC para deshabilitar la detección de instalaciones.

De la misma manera que llevamos haciendo, hacemos clic derecho > Editar a nuestra GPO y buscamos la directiva en cuestión.

![Captura apartado 1](pr0504_Capturas/pr0504_22.png)
...
En el apartado de Filtros WMI hacemos clic derecho y le damos a Nuevo. Creamos el filtro con la siguiente configuración:

En la consulta WMI escibiremos:

`SELECT * FROM Win32_OperatingSystem WHERE ProductType = 1`

![Captura apartado 1](pr0504_Capturas/pr0504_23.png)

Por último, lo vinculamos a nuestra GPO:

![Captura apartado 1](pr0504_Capturas/pr0504_24.png)
